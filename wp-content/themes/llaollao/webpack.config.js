...
module.exports = {
	...
	entry: {
		...
		'side-images/build/index':       path.resolve( __dirname, 'blocks/side-images/src/index.js' ),
		'side-image-column/build/index': path.resolve( __dirname, 'blocks/side-image-column/src/index.js' ),
		'history/build/index':           path.resolve( __dirname, 'blocks/history/src/index.js' ),
		'history/build/view':            path.resolve( __dirname, 'blocks/history/src/view.js' ),
		'history-item/build/index':      path.resolve( __dirname, 'blocks/history-item/src/index.js' ),
